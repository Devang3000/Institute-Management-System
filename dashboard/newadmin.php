...
<head>
    ...
    <script>
        $(document).ready(function() {
            loadSection('overview', 1);  // Load overview by default
...
<body>
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                <li><a href="#" data-section="overview">Dashboard Overview</a></li>
                <li><a href="#" data-section="courses">Courses</a></li>
                <li><a href="#" data-section="enrollments">Enrollments</a></li>
                <li><a href="#" data-section="enquiries">Enquiries</a></li>
                <li><a href="#" data-section="payments">Payments</a></li>
                <li><a href="#" data-section="admin-accounts">Admin Accounts</a></li>
                <li><a href="#" data-section="student-logins">Student Logins</a></li>
            </ul>
        </div>
        <div class="content">
            <section id="overview">
            ...
            <section id="enrollments">
                <!-- Enrollments data will be loaded here -->
            </section>
            <section id="enquiries">
                <!-- Enquiries data will be loaded here -->
            </section>
            <section id="payments">
                <!-- Payments data will be loaded here -->
            </section>
            <section id="admin-accounts">
                <!-- Admin accounts data will be loaded here -->
            </section>
            <section id="student-logins">
                <!-- Student logins data will be loaded here -->
            </section>
        </div>
    </div>
    <script>
